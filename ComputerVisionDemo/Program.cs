...
namespace ComputerVisionDemo
{
    class Program
    {
        static string subscriptionkey = "640435d0350a43e483d033f36375415d";
        static string endpoint = "https://computervisionjcplatzi.cognitiveservices.azure.com/";
        private const string ANALYZE_URL_IMAGE = "https://i.imgur.com/QYtuGUm.jpeg";
            //"https://moderatorsampleimages.blob.core.windows.net/samples/sample16.png";

        static void Main(string[] args)
        {
            Console.WriteLine("Utilizando computer vision");
